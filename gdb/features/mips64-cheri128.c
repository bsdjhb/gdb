...
initialize_tdesc_mips64_cheri128 (void)
{
  ...
  tdesc_create_reg (feature, "ddc", 90, 1, NULL, 128, "cheri_cap128");
  ...
  tdesc_create_reg (feature, "stc", 101, 1, NULL, 128, "cheri_cap128");
  ...
  tdesc_create_reg (feature, "idc", 116, 1, NULL, 128, "cheri_cap128");
  tdesc_create_reg (feature, "kr1c", 117, 1, NULL, 128, "cheri_cap128");
  tdesc_create_reg (feature, "kr2c", 118, 1, NULL, 128, "cheri_cap128");
  tdesc_create_reg (feature, "kcc", 119, 1, NULL, 128, "cheri_cap128");
  tdesc_create_reg (feature, "kdc", 120, 1, NULL, 128, "cheri_cap128");
